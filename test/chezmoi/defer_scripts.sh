...
check "chezmoi apply is called with --include=scripts --exclude=encrypted in post-create script" grep -q 'chezmoi apply --include=scripts --exclude=encrypted' /usr/local/share/chezmoi-post-create.sh
